...
# # another way to display df_trial
# chart_data = df_trial
...
# COVER_BCN = [
#     [[2.183787, 41.507757], [2.151772 ,41.283110], [2.305666, 41.407666], [1.984145, 41.385002]]
# ]

INITIAL_VIEW_STATE_BCN = pdk.ViewState(
    latitude=41.39, longitude=2.15, zoom=10, max_zoom=16, pitch=45, bearing=0
)

geojson_bcn = pdk.Layer("GeoJsonLayer",
    data=df_geo,
    get_fill_color=[255, 255, 255],
    get_line_color=[0,0,0],
    get_elevation="Target",
    # initial_view_state=COVER_BCN
)

bcn = pdk.Deck(layers=[geojson_bcn], initial_view_state=INITIAL_VIEW_STATE_BCN)
st.pydeck_chart(bcn)